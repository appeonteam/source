...
type cb_toolbar from u_cb within w_profiles
end type
...
int iCurrent
call super::create
this.cb_toolbar=create cb_toolbar
...
this.Control[iCurrent+1]=this.cb_toolbar
