...
public subroutine of_gotodirectory (string as_directory)
...
public subroutine of_gotodirectory (string as_directory);// goto a directory in the treeview and then show it in the listview
...
event ue_postopen;call super::ue_postopen;n_filesys ln_fsys
TreeViewItem ltvi_item
Integer li_cnt, li_max, li_type[]
Long ll_parent, ll_item
String ls_drive[], ls_label[]
...
// add shell icons
tv_drives.of_ImportIcon("shell32.dll", 16)	// MyComputer
tv_drives.of_ImportIcon("shell32.dll", 7)		// Floppy
tv_drives.of_ImportIcon("shell32.dll", 9)		// LocalDrive
tv_drives.of_ImportIcon("shell32.dll", 10)	// NetDrive
tv_drives.of_ImportIcon("shell32.dll", 12)	// CD-ROM
tv_drives.of_ImportIcon("shell32.dll", 4)		// Folder
tv_drives.of_ImportIcon("shell32.dll", 5)		// FolderOpen
tv_drives.of_ImportIcon("shell32.dll", 127)	// MyDocuments
...
event selectionchanged;of_populate_listview(newhandle)
