...
this.Control[iCurrent+2]=this.st_saved
this.Control[iCurrent+3]=this.cb_add
this.Control[iCurrent+4]=this.lb_directories
this.Control[iCurrent+5]=this.cb_browse
this.Control[iCurrent+6]=this.st_directory
this.Control[iCurrent+7]=this.sle_directory
