$PBExportHeader$w_simulate_sync_options.srw
forward
global type w_simulate_sync_options from window
end type
type cb_cancel from commandbutton within w_simulate_sync_options
end type
type cb_ok from commandbutton within w_simulate_sync_options
end type
type tab_1 from tab within w_simulate_sync_options
end type
...
global w_simulate_sync_options w_simulate_sync_options
...
on w_simulate_sync_options.create
...
on w_simulate_sync_options.destroy
