$PBExportHeader$n_simulate_connectservice.sru
$PBExportComments$Generated Database Connection Service
forward
global type n_simulate_connectservice from nonvisualobject
end type
end forward

global type n_simulate_connectservice from nonvisualobject
end type
global n_simulate_connectservice n_simulate_connectservice
...
Choose Case is_connectfrom
	...
	Case IS_USE_INIFILE						/*  Populate Database Connection from INI file  */
		string ls_inifile = "C:\20180104\Simulate\simulate.ini"
...
on n_simulate_connectservice.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_simulate_connectservice.destroy
