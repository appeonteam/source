$PBExportHeader$nvo_simulate_mlsync.sru
$PBExportComments$Non-visual object that controls dbmlsync
forward
global type nvo_simulate_mlsync from mlsync
end type
end forward

global type nvo_simulate_mlsync from mlsync
string additionalopts = ""
string datasource = "PB Demo DB V2017R2 Unicode"
string dbpass = "sql"
string dbuser = "dba"
string extendedopts = ""
string host = ""  
string logopts = " -v+ -vc"
string port = ""
string progresswindowname = "w_simulate_syncprogress"
string publication = "test"
string logfilename = ""
string syncregistrykey = "Software\Sybase\PowerBuilder\17.0\simulate"
// 
...
global nvo_simulate_mlsync nvo_simulate_mlsync

type variables
w_simulate_syncprogress		i_syncwindow
...
on nvo_simulate_mlsync.create
call super::create
TriggerEvent( this, "constructor" )
end on

on nvo_simulate_mlsync.destroy
