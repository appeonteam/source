$PBExportHeader$n_cst_dw_unload_in_rtf_app.sru
$PBExportComments$обьект выгрузки в rtf для использования в приложениии
forward
global type n_cst_dw_unload_in_rtf_app from n_cst_dw_unload_in_rtf
end type
end forward

global type n_cst_dw_unload_in_rtf_app from n_cst_dw_unload_in_rtf
end type
global n_cst_dw_unload_in_rtf_app n_cst_dw_unload_in_rtf_app

on n_cst_dw_unload_in_rtf_app.create
TriggerEvent( this, "constructor" )
end on

on n_cst_dw_unload_in_rtf_app.destroy
