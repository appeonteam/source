$PBExportHeader$n_cst_dw_unload_in_xls_ole_app.sru
$PBExportComments$выгрузка в xls через ole для использования в приложениии
forward
global type n_cst_dw_unload_in_xls_ole_app from n_cst_dw_unload_in_xls_ole
end type
end forward

global type n_cst_dw_unload_in_xls_ole_app from n_cst_dw_unload_in_xls_ole
end type
global n_cst_dw_unload_in_xls_ole_app n_cst_dw_unload_in_xls_ole_app

on n_cst_dw_unload_in_xls_ole_app.create
TriggerEvent( this, "constructor" )
end on

on n_cst_dw_unload_in_xls_ole_app.destroy
