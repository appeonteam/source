$PBExportHeader$n_cst_xpheader_painter.sru
forward
global type n_cst_xpheader_painter from n_cst_base_painter
end type
end forward
...
on n_cst_xpheader_painter.create
call super::create
end on

on n_cst_xpheader_painter.destroy
call super::destroy
end on
