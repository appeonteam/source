...
FOR ll_index = 1 TO 9
	inv_win32.SetPixel(ahdc, ll_start, 2, RGB(255,255,255))
	inv_win32.SetPixel(ahdc, ll_start + 1, 2, RGB(255,255,255))
	inv_win32.SetPixel(ahdc, ll_start, 3, RGB(255,255,255))
	inv_win32.SetPixel(ahdc, ll_start + 1, 3, RGB(255,255,255))
	
	inv_win32.SetPixel(ahdc, ll_start - 1, 1, RGB(40,50,71))
	inv_win32.SetPixel(ahdc, ll_start, 1, RGB(40,50,71))
	inv_win32.SetPixel(ahdc, ll_start - 1, 2, RGB(40,50,71))
	inv_win32.SetPixel(ahdc, ll_start, 2, RGB(97,116,152))
