$PBExportHeader$u_cst_powerdockclose.sru
forward
...
inv_win32.SetPixel(ahdc, 22, 4 + ll_y, 0)
inv_win32.SetPixel(ahdc, 23, 4 + ll_y, 0)
inv_win32.SetPixel(ahdc, 29, 4 + ll_y, 0)
inv_win32.SetPixel(ahdc, 30, 4 + ll_y, 0)

inv_win32.SetPixel(ahdc, 23, 5 + ll_y, 0)
inv_win32.SetPixel(ahdc, 24, 5 + ll_y, 0)
inv_win32.SetPixel(ahdc, 28, 5 + ll_y, 0)
inv_win32.SetPixel(ahdc, 29, 5 + ll_y, 0)

inv_win32.SetPixel(ahdc, 24, 6 + ll_y, 0)
inv_win32.SetPixel(ahdc, 25, 6 + ll_y, 0)
inv_win32.SetPixel(ahdc, 27, 6 + ll_y, 0)
inv_win32.SetPixel(ahdc, 28, 6 + ll_y, 0)

inv_win32.SetPixel(ahdc, 25, 7 + ll_y, 0)
inv_win32.SetPixel(ahdc, 26, 7 + ll_y, 0)
inv_win32.SetPixel(ahdc, 27, 7 + ll_y, 0)

inv_win32.SetPixel(ahdc, 25, 8 + ll_y, 0)
inv_win32.SetPixel(ahdc, 26, 8 + ll_y, 0)
inv_win32.SetPixel(ahdc, 27, 8 + ll_y, 0)

inv_win32.SetPixel(ahdc, 24, 9 + ll_y, 0)
inv_win32.SetPixel(ahdc, 25, 9 + ll_y, 0)
inv_win32.SetPixel(ahdc, 27, 9 + ll_y, 0)
inv_win32.SetPixel(ahdc, 28, 9 + ll_y, 0)

inv_win32.SetPixel(ahdc, 23, 10 + ll_y, 0)
inv_win32.SetPixel(ahdc, 24, 10 + ll_y, 0)
inv_win32.SetPixel(ahdc, 28, 10 + ll_y, 0)
inv_win32.SetPixel(ahdc, 29, 10 + ll_y, 0)

inv_win32.SetPixel(ahdc, 22, 11 + ll_y, 0)
inv_win32.SetPixel(ahdc, 23, 11 + ll_y, 0)
inv_win32.SetPixel(ahdc, 29, 11 + ll_y, 0)
inv_win32.SetPixel(ahdc, 30, 11 + ll_y, 0)
...
inv_win32.SetPixel(ahdc, 4, 6 + ll_y, 0)
inv_win32.SetPixel(ahdc, 5, 6 + ll_y, 0)
inv_win32.SetPixel(ahdc, 6, 6 + ll_y, 0)
inv_win32.SetPixel(ahdc, 7, 6 + ll_y, 0)
inv_win32.SetPixel(ahdc, 8, 6 + ll_y, 0)
inv_win32.SetPixel(ahdc, 9, 6 + ll_y, 0)
inv_win32.SetPixel(ahdc, 10, 6 + ll_y, 0)
inv_win32.SetPixel(ahdc, 11, 6 + ll_y, 0)

inv_win32.SetPixel(ahdc, 5, 7 + ll_y, 0)
inv_win32.SetPixel(ahdc, 6, 7 + ll_y, 0)
inv_win32.SetPixel(ahdc, 7, 7 + ll_y, 0)
inv_win32.SetPixel(ahdc, 8, 7 + ll_y, 0)
inv_win32.SetPixel(ahdc, 9, 7 + ll_y, 0)
inv_win32.SetPixel(ahdc, 10, 7 + ll_y, 0)

inv_win32.SetPixel(ahdc, 6, 8 + ll_y, 0)
inv_win32.SetPixel(ahdc, 7, 8 + ll_y, 0)
inv_win32.SetPixel(ahdc, 8, 8 + ll_y, 0)
inv_win32.SetPixel(ahdc, 9, 8 + ll_y, 0)

inv_win32.SetPixel(ahdc, 7, 9 + ll_y, 0)
inv_win32.SetPixel(ahdc, 8, 9 + ll_y, 0)
...
FOR ll_index1 = 0 TO 34
	...
	FOR ll_index2 = 0 TO ll_height
		inv_win32.SetPixel(hdc, ll_index1, ll_index2, ll_color)
	NEXT
...
IF NOT IsValid(iuo_parent) THEN RETURN 0
...
IF ib_mousecaptured THEN
	IF il_x < 16 THEN
		...
		hRgn = inv_win32.CreateRectRgn (0, 2 , 16 , 18 )
		...
		hRgn = inv_win32.CreateRectRgn (1, 3 , 15 , 17 )
	...
	ELSE
		IF il_x > 18 THEN
			...
			hRgn = inv_win32.CreateRectRgn (18, 2 , 34 , 18 )
			hRPen = inv_win32.CreatePen(0,0,RGB(49,106,197))
			inv_win32.FillRgn (hdc, hRgn , hRPen )
			inv_win32.DeleteObject(hRPen)
			inv_win32.DeleteObject(hRgn)
			
			hRgn = inv_win32.CreateRectRgn (19, 3 , 33 , 17 )
			hRPen = inv_win32.CreatePen(0,0,RGB(193,210,238))
			inv_win32.FillRgn (hdc, hRgn , hRPen )
			inv_win32.DeleteObject(hRPen)
			inv_win32.DeleteObject(hRgn)
...
type p_canvas from u_cst_canvas`p_canvas within u_cst_powerdockclose
end type
