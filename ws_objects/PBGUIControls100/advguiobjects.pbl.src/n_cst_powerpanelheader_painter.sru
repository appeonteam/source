$PBExportHeader$n_cst_powerpanelheader_painter.sru
forward
global type n_cst_powerpanelheader_painter from n_cst_base_painter
end type
end forward
...
on n_cst_powerpanelheader_painter.create
call super::create
end on

on n_cst_powerpanelheader_painter.destroy
call super::destroy
end on
