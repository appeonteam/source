...
event uimselectionchanged ( )
event uimselectionchanging ( )
event close ( )
event open ( )
event uimclose ( )
event uimopen ( )
...
event uimselectionchanged();Trigger Event SelectionChanged(Message.WordParm, Message.LongParm)
end event

event uimselectionchanging();Trigger Event SelectionChanging(Message.WordParm, Message.LongParm)
end event

event uimclose();Trigger Event Close()
end event

event uimopen();Trigger Event Open()
end event
