$PBExportHeader$w_genapp_syncprogress.srw
$PBExportComments$Window for running dbmlsync
forward
global type w_genapp_syncprogress from window
end type
type st_phasebar from statictext within w_genapp_syncprogress
end type
type hpb_progress from hprogressbar within w_genapp_syncprogress
end type
type mle_status from multilineedit within w_genapp_syncprogress
end type
type cb_ok from commandbutton within w_genapp_syncprogress
end type
type cb_cancel from commandbutton within w_genapp_syncprogress
end type
end forward
...
global w_genapp_syncprogress w_genapp_syncprogress
...
on w_genapp_syncprogress.create
...
on w_genapp_syncprogress.destroy
...
if IsValid(i_uosync) and i_uosync.TypeOf() = MlSync! then
	...
	'OpenWithParm(w_genapp_syncprogress, instance_of_MLSync!)~r~n'
end if
