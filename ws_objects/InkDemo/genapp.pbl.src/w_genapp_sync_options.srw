$PBExportHeader$w_genapp_sync_options.srw
forward
global type w_genapp_sync_options from window
end type
type cb_cancel from commandbutton within w_genapp_sync_options
end type
type cb_ok from commandbutton within w_genapp_sync_options
end type
type tab_1 from tab within w_genapp_sync_options
end type
...
global w_genapp_sync_options w_genapp_sync_options
...
on w_genapp_sync_options.create
...
on w_genapp_sync_options.destroy
