$PBExportHeader$nvo_genapp_mlsync.sru
$PBExportComments$Non-visual object that controls dbmlsync
forward
global type nvo_genapp_mlsync from mlsync
end type
end forward
...
string logopts = ""
string port = ""
string progresswindowname = "w_genapp_syncprogress"
string publication = "test"
string logfilename = ""
string syncregistrykey = "Software\Sybase\PowerBuilder\12.6\genapp"
// 
...
global nvo_genapp_mlsync nvo_genapp_mlsync

type variables
w_genapp_syncprogress		i_syncwindow
...
on nvo_genapp_mlsync.create
call super::create
TriggerEvent( this, "constructor" )
end on

on nvo_genapp_mlsync.destroy
